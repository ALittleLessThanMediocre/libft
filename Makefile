...
CFILES= ft_memset.c	ft_bzero.c		ft_memcpy.c		ft_memccpy.c \
	...
	ft_isspace.c	ft_isupper.c	ft_islower.c	ft_wordcount.c \
	ft_nbrlen.c		ft_wordlen.c	ft_ismspace.c	ft_lstadd.c \
	ft_lstapnd.c	ft_lstcmp.c		ft_lstdel.c 	ft_lstdelone.c \
	ft_lstiter.c	ft_lstlen.c		ft_lstloop.c 	ft_lstmap.c \
